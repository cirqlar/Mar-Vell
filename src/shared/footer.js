        ...
        <div className={styles.content}>
          <div className={styles.main}>
            ...
            <nav className={styles.primary}>
              <ul>
                ...
                <li>
                  <a href="https://jobs.disneycareers.com/search-jobs?orgIds=391-1635-24091&amp;ascf=[{%22key%22:%22custom_fields%252EIndustryCustomField%22,%22value%22:%22Marvel%20Entertainment%22}]">Careers</a>
                </li>
                <li>
          ...
          <nav className={styles.follow}>
            ...
            <ul>
              ...
              <li>
                <a target="_blank" rel="noopener noreferrer" href="http://twitter.com/marvel">
                  <span>
              ...
              <li>
                <a target="_blank" rel="noopener noreferrer" href="http://instagram.com/marvel">
                  <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18">
              ...
              <li>
                <a target="_blank" rel="noopener noreferrer" href="http://youtube.com/marvel">
                  <span>
